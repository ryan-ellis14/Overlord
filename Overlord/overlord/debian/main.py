...
from PyQt6.QtWidgets import QApplication, QMainWindow, QStackedWidget, QGridLayout, QVBoxLayout, QWidget
...
class MainKioskWindow(QMainWindow):
    ...
    def _setup_bottom_bar(self):
        ...
        bar_layout.setColumnStretch(2, 0)
        ...
        bar_layout.addWidget(self._page_indicator, 0, 1)
        ...
        bar_layout.addWidget(self._btn_next, 0, 2)
    ...
    def _open_kiosk_settings(self):
        ...
        self._settings_window = SettingsWindow(self._pin_manager, parent=self)
